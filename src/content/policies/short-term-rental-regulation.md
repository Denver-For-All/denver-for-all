---
title: 'Short-Term Rental Reform: Housing First, Hotels Second'
titleEs: 'Reforma de Alquileres a Corto Plazo: Primero la Vivienda, Después los Hoteles'
summary: 'Thousands of Denver homes sit empty except for tourists while workers cannot find affordable rentals. Restrict short-term rentals to primary residences, ban investor-owned STRs, and return housing to Denverites.'
summaryEs: 'Miles de hogares en Denver permanecen vacíos excepto para turistas, mientras los trabajadores no pueden encontrar alquileres asequibles. Restringir los alquileres a corto plazo a residencias primarias, prohibir los STR de inversores y devolver la vivienda a los habitantes de Denver.'
category: 'housing'
icon: 'home'
order: 10
status: 'draft'
...
keyStats:
  - value: '3,500+'
    label: 'Denver units listed on Airbnb/VRBO as of 2024'
    labelEs: 'unidades de Denver listadas en Airbnb/VRBO en 2024'
    context: 'Every unit rented to tourists is a unit not available to a Denver family or worker seeking a long-term home'
    contextEs: 'Cada unidad alquilada a turistas es una unidad que no está disponible para una familia o trabajador de Denver que busca un hogar a largo plazo'
    source: 'Inside Airbnb, Denver dataset, 2024'
    theme: 'danger'
  - value: '43%'
    label: 'of Denver STR listings owned by hosts with multiple properties'
    labelEs: 'de los listados de STR de Denver son de anfitriones con múltiples propiedades'
    context: 'Nearly half of all short-term rental activity is commercial speculation, not homeowners sharing a spare room'
