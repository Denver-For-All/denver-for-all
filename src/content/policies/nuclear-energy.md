---
title: 'Nuclear Energy Readiness - Small Modular Reactors for Denver'
titleEs: 'Preparación para Energía Nuclear - Reactores Modulares Pequeños para Denver'
summary: 'Position Denver to deploy clean, firm baseload nuclear power as SMR technology matures. Support DIA feasibility study. Leverage HB25-1040 to include nuclear in clean energy planning. Protect ratepayers from first-of-a-kind cost risk. Complement - not replace - renewable energy expansion.'
summaryEs: 'Posicionar a Denver para desplegar energía nuclear limpia y firme como carga base a medida que la tecnología SMR madure. Apoyar el estudio de viabilidad de DIA. Aprovechar HB25-1040 para incluir la energía nuclear en la planificación de energía limpia. Proteger a los contribuyentes del riesgo de costos de primera generación. Complementar - no reemplazar - la expansión de energías renovables.'
...
keyStats:
  - value: '320 MW'
    label: 'from a 4-pack Xe-100 - enough for 240,000 homes'
    labelEs: 'de un paquete de 4 Xe-100 - suficiente para 240,000 hogares'
    context: 'Denver has ~320,000 households. A single 4-pack SMR installation could provide 75% of residential baseload.'
    contextEs: 'Denver tiene ~320,000 hogares. Una sola instalación SMR de 4 unidades podría proveer el 75% de la carga base residencial.'
    source: 'X-energy Xe-100 specifications, 80 MW per module'
    theme: 'primary'
  - value: '93%+'
    label: 'capacity factor - nuclear vs 35% wind, 25% solar'
    labelEs: 'factor de capacidad - nuclear vs 35% eólica, 25% solar'
    context: 'Nuclear runs 24/7. Wind and solar in Colorado produce power roughly one-quarter to one-third of the time.'
    contextEs: 'La energía nuclear funciona 24/7. La eólica y solar en Colorado producen energía aproximadamente una cuarta a una tercera parte del tiempo.'
  ...
  - value: '5.8 GW'
    ...
    theme: 'danger'
relatedLegislation:
  - billNumber: 'HB25-1040'
    title: 'Classify Nuclear Energy as Clean Energy'
    status: 'Signed into law April 2025'
    session: '2025'
    url: 'https://leg.colorado.gov/bills/hb25-1040'
  - billNumber: 'SB26-022'
...
Denver faces an energy trilemma: the grid is unreliable (see [Power Reliability & Municipal Energy](/platform/power-reliability)), demand is surging, and climate targets require eliminating fossil fuels. Wind and solar are essential - but they are intermittent. Colorado wind farms produce power roughly 35% of the time; solar panels roughly 25% (EIA, 2024). The other 65-75% of the time, something else has to keep the lights on.
...
**Helium-cooled, not water-cooled.** This is critical for Colorado. The state receives 14-17 inches of precipitation per year - half the national average - and faces a megadrought on the Colorado River (see [Water Security & Conservation](/platform/water-security)). Light-water reactors consume enormous quantities of water for cooling. The Xe-100 uses helium gas as its coolant, requiring minimal water. In a drought-prone state, this is not a minor advantage - it is a prerequisite.
...
1. **NuScale's design required massive on-site civil works.** The light-water SMR modules sat in a large underground pool, incurring enormous fixed construction costs regardless of the number of modules. The Xe-100 avoids this - modules are self-contained, factory-built units that do not require a shared containment pool.

2. **Wrong first customer.** UAMPS was a consortium of small municipal utilities with no nuclear experience and no ability to absorb cost risk. Denver - if it pursues nuclear through a municipal utility or a franchise requirement - would bring far greater institutional capacity and financial depth.

3. **Initial cost estimates were not trustworthy.** NuScale's costs more than doubled from $9,964/kW in 2015 to $21,561/kW by cancellation. This is not unique to NuScale - it is a pattern across nuclear projects globally. Any Denver nuclear proposal must include binding cost protections and off-ramps.

4. **Premature commitment.** NuScale launched the project before completing NRC design certification. Denver should not commit capital until the Xe-100 completes design certification and demonstrates costs at the Dow Seadrift facility in Texas.
...
- Include nuclear in any future municipal utility integrated resource plan (cross-reference: [Power Reliability & Municipal Energy](/platform/power-reliability))
...
**"After Rocky Flats, how can you propose nuclear energy for Denver?"**
Rocky Flats was a nuclear weapons plant that enriched weapons-grade plutonium with a reckless safety culture during the Cold War. An Xe-100 small modular reactor uses low-enriched uranium in TRISO fuel that is physically incapable of melting down, cooled by inert helium gas, with passive safety systems that shut the reactor down through the laws of physics - no operator action required. These are fundamentally different technologies. Acknowledging Rocky Flats' contamination (which we demand be independently investigated - see [Climate & Environmental Justice](/platform/climate-environment)) and supporting modern nuclear energy are not contradictory. A city that takes nuclear safety seriously does both: demands accountability for past harm and insists on the highest safety standards for future technology.

**"Aren't renewables cheaper? Why not just build more wind and solar?"**
