...
1. **Ending chronic homelessness:** 300 new PSH units with wraparound services directly target the chronically homeless population using the HUD-endorsed Housing First approach
2. **Reducing unsheltered homelessness:** Rapid rehousing for 200 households/year provides a faster pathway out of unsheltered homelessness for individuals and families who do not require permanent support
3. **Shortening the length of time persons remain homeless:** Coordinated entry upgrades and real-time unit tracking reduce assessment-to-placement timelines
4. **Reducing returns to homelessness:** Housing First's 80-90% retention rate and intensive case management minimize returns compared to the current system
5. **Increasing employment and income for program participants:** Benefits enrollment and employment services integrated into case management
6. **Serving persons from underserved communities and marginalized populations:** Low-barrier admission and targeted outreach to communities disproportionately represented in Denver's homeless population
...
All data sourced from the Denver For All [Housing First](/platform/housing-first) policy analysis. Primary sources include:
