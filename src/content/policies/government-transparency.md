...
- All city spending data published in real-time, searchable, and downloadable -- not quarterly reports, real-time
- Police data: use of force incidents, civilian complaints, disciplinary outcomes, and stop data -- all public, updated monthly (cross-reference: [Public Safety & Policing](/platform/public-safety))
