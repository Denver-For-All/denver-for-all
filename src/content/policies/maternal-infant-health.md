...
But the financial toll is only part of it. Families in the NICU and PICU for extended stays — weeks, months, sometimes more than a year — witness a healthcare system breaking under its own weight:
...
- **Racism in clinical settings has no accountability mechanism.** Families of color in the NICU report racist comments, differential treatment, dismissal of concerns, and outright hostility from staff — and have almost no recourse. Hospital complaint processes are designed to protect the institution, not the patient. When hospitals are so short-staffed they cannot afford to discipline anyone, racist behavior is effectively tolerated. The staffing crisis and the racism crisis are not separate problems. They reinforce each other. A hospital that won't fire a nurse for making racist jokes because it can't replace them has decided that Black and brown families' dignity is less important than its staffing spreadsheet.
...
### 3. Healthcare Anti-Racism Accountability

Racist behavior in healthcare settings is a patient safety issue. It causes measurable harm. And right now, there is no meaningful accountability mechanism in Denver.

- **Independent Patient Equity Ombudsman**: a city-funded, independent office (not employed by any hospital) where patients and families can report racial discrimination, harassment, and bias in healthcare settings. The ombudsman has investigative authority, can compel hospitals to respond, and publishes an annual report on complaints and outcomes. Hospitals cannot bury discrimination complaints in internal HR processes that protect the institution
- **Hospital equity metrics tied to city licensing**: Denver hospitals must track and publicly report patient experience data stratified by race and ethnicity — including complaint rates, pain management equity, C-section rates by race, and NICU admission rates by race. Persistent disparities without documented improvement plans trigger review by the Denver Board of Health
- **Anti-racism standards with structural teeth**: mandatory, evidence-based training is a floor, not a ceiling. The ceiling is accountability. Hospitals must maintain clear, published policies for addressing racist behavior by staff toward patients, with defined consequences that are enforced regardless of staffing pressure. When a hospital decides it cannot discipline a staff member for racist conduct because it is short-staffed, it has made a policy choice — and that choice must have consequences
- **Whistleblower protections**: healthcare workers who report unsafe conditions, racist behavior by colleagues, or staffing-related patient safety concerns are protected from retaliation under Denver municipal code. Staff who speak up are not the problem. Institutions that punish them are
...
**"Isn't maternal health a state or federal issue?"**
