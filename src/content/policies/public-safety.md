...
- Public hearings on use-of-force incidents
...
- **ALPR data retention limited to 30 days** instead of indefinite mass tracking of Denver residents' movements
...
**Take action now:** [Sign the petition to turn off Flock cameras](https://resist.bot/petitions/PYOELO) | [Sign the petition for a state surveillance oversight law](https://resist.bot/petitions/PPGCFY). You can also text "sign PYOELO" or "sign PPGCFY" to 50409. Every signature sends a personalized letter to your own elected officials. [See all campaigns →](/tools/resistbot)
