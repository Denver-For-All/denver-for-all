...
- Keep bill numbers (HB26-1015, SB25-001, etc.) as-is
- Keep program names (Section 8, Continuum of Care, etc.) in English, optionally with translated name in parentheses on first use
- For bullet-pointed data (like cost comparisons), keep the numbers and translate the descriptions
