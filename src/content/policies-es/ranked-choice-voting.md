...
- **El colapso de la participación da un poder desproporcionado a minorías organizadas.**

Colorado aprobó la HB24-1190 en 2024, autorizando a los municipios a adoptar la votación por orden de preferencia. Denver tiene la autoridad legal para actuar. Ha optado por no hacerlo.

## Nuestra Solución

### 1. Adoptar la Votación por Orden de Preferencia para Todas las Elecciones Municipales de Denver
...
Registro automático de votantes para todo residente de Denver que interactúe con una agencia de la ciudad.

### 3. Ampliar la Votación Anticipada y los Centros de Votación

- Período de votación anticipada de 10 días para todas las elecciones municipales.
- Al menos un centro de votación por distrito del Concejo Municipal.
- Registro el mismo día en todos los centros de votación.

### 4. Redistribución No Partidista e Independiente

Adoptar un modelo de **comisión de redistribución independiente** con 11 miembros y criterios de igualdad poblacional, cumplimiento de la Ley de Derechos de Voto y compacidad geográfica.
...
**"¿Es la VOP demasiado complicada para los votantes?"**
No. Las encuestas de salida de cada ciudad que ha adoptado la VOP muestran que más del 70% de los votantes la encuentra sencilla. La papeleta te pide que numeres tus opciones: 1, 2, 3.

**"¿Y si mi primera opción pierde? ¿Se desperdicia mi voto?"**
Eso es exactamente lo que la VOP evita. Si tu primera opción es eliminada, tu voto se transfiere a tu segunda opción. Tu voto sigue contando hasta que tu candidato gane o hayas agotado todas tus preferencias.
