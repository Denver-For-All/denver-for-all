...
**City Services:** Denver's city website and digital services are not fully WCAG 2.1 AA compliant. Public meetings often lack ASL interpretation unless specifically requested days in advance. The Commission for People with Disabilities exists but is advisory-only with limited budget and no enforcement authority.

### What Denver Currently Does

Denver has a fragmented foundation:

- **Denver Commission for People with Disabilities** (advisory board, appointed by the mayor): makes recommendations on accessibility and disability policy. Limited budget, no enforcement authority.
- **ADA Coordinator** within the city: handles individual accommodation requests and complaints. Reactive, not proactive.
...
### 1. ADA Enforcement With Real Teeth
...
- **All city digital services** WCAG 2.1 AA compliant within 1 year, WCAG 2.2 AA within 3 years. No exceptions for "legacy systems"

### 2. Accessible Housing Mandate

- **15% of all units in new multifamily construction** (10+ units) must meet universal design standards: zero-step entry, 36-inch doorways, reinforced bathroom walls, lever hardware, and accessible kitchen layout. This exceeds the ADA minimum of 5% in federally funded projects and applies to all new construction, not just subsidized
- **All new city-funded affordable housing** (social housing, LIHTC, Denver housing bond projects) must include 10% fully accessible units (wheelchair-accessible, roll-in shower, adjustable countertops) and 15% adaptable units
- **Accessible housing registry**: Denver maintains a public database of accessible rental units, searchable by accessibility features, so disabled renters can actually find housing that works for them
- **Home modification grants**: expand the existing aging-in-place program to cover all disabled residents regardless of age. Grants of up to $15,000 for ramps, widened doorways, roll-in showers, stair lifts, and smart home modifications
- Cross-reference: [Social Housing](/platform/social-housing), [Aging, Disability & Accessibility](/platform/aging-accessibility)

### 3. Disability Employment & Economic Inclusion

- **Eliminate Section 14(c) subminimum wage** in Denver: no employer operating within city limits may pay a disabled worker below the Denver minimum wage. Period. (Cross-reference: [Living Wage](/platform/living-wage))
- **City contractor disability hiring requirement**: all city contracts over $100,000 must include disability hiring goals (7% of workforce, matching the federal Section 503 standard for federal contractors). Track and report annually
- **Supported employment expansion**: fund evidence-based Individual Placement and Support (IPS) programs that place disabled workers directly into competitive integrated employment with ongoing job coaching. IPS has a 55-65% placement rate vs. 20-25% for traditional vocational rehabilitation (Dartmouth IPS Employment Center)
- **Disability-owned business support**: include disability-owned businesses in Denver's existing MWBE (Minority and Women-Owned Business Enterprise) procurement preferences. Create a disability entrepreneur incubator with shared accessible workspace, mentoring, and city contract navigation support
- **City of Denver as model employer**: 7% disability hiring target for all city departments. Centralized reasonable accommodations fund so individual departments don't absorb costs. Paid internship program for disabled youth and young adults
...
**"Isn't the ADA already enough?"**
The ADA is 35 years old and sets a floor, not a ceiling. Denver's own auditor found the city's sidewalk program was "not designed for ADA compliance" and decades behind schedule. ADA enforcement is complaint-driven and underfunded nationally. The result: businesses that have been non-compliant since 1990 with no consequences. Our proposal pairs proactive audits with support (free assessments, small business grants) and enforcement (licensing consequences for refusal to remediate). Compliance should be the default, not the exception.

**"Universal design in new construction is too expensive."**
The National Association of Home Builders found universal design features add $100-$600 per unit in new construction. Retrofitting an existing unit for accessibility costs $10,000-$50,000+. Building it right the first time is dramatically cheaper. And universal design benefits everyone: parents with strollers, people with temporary injuries, delivery workers, older adults, and anyone who will ever age. This is good design, not special accommodation.

**"Denver already has a Commission for People with Disabilities."**
