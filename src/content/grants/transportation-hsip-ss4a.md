...
- Alameda Avenue
- Broadway / Lincoln corridor
- Colorado Boulevard
- Havana Street
- Smith Road / Central Park Boulevard
- 56th Avenue / Pena Boulevard approaches
- Montbello / Green Valley Ranch arterial network

**Urbanized Area:** Denver-Aurora-Lakewood, CO Metropolitan Statistical Area

**Underserved Communities:** Montbello, Green Valley Ranch, Far Northeast, and Westwood are the most transportation-underserved neighborhoods in Denver. These communities face car-dependent street design with inadequate transit service, the highest pedestrian crash rates, and the fewest safe cycling facilities. When RTD built the A Line to the airport, it routed around Montbello and cut bus routes from seven to three, simultaneously creating a transit desert and a food desert. Multiple target intersections and corridors fall within Census tracts that qualify as disadvantaged communities under the Justice40 initiative.

### C. Safety Problem Identification
...
- Pedestrians are approximately 30x more likely to die than vehicle occupants per trip
- The I-70/Peoria interchange recorded 103 crashes in a single year (2024)
...
- Each intersection redesign to include a Road Safety Audit (RSA) in the design phase and a post-construction safety evaluation at 12 and 24 months
- Engineering design to follow FHWA Proven Safety Countermeasures and NACTO intersection design guidance
...
- Include protected intersection treatments at major cross-streets to eliminate the highest-risk conflict points for cyclists
- Install bike signal phases at signalized intersections along protected corridors
- Coordinate with Denver Moves: Bikes plan to maximize network connectivity and advance the city's goal of placing a high-comfort bikeway within a quarter-mile of every household
...
- Install supporting infrastructure at each location: school zone gateway signage, flashing beacons, and high-visibility crosswalk markings
...
- Add Rectangular Rapid Flashing Beacons (RRFBs) at 15-20 uncontrolled marked crosswalks on arterial roads within the High Injury Network
...
- Pre-construction baseline data collection: crash frequency and severity, vehicle speeds (85th percentile), pedestrian and bicycle counts, and community perception surveys
- Post-construction evaluation at 12, 24, and 36 months using the same metrics
- Final evaluation report documenting methodology, outcomes, cost-effectiveness, and replicability for other Denver corridors and peer cities
- Quarterly progress reports to FHWA/USDOT as required by grant terms
...
All data sourced from the Denver For All [Transportation & Public Transit](/platform/transportation) policy analysis. Primary sources include:

- City and County of Denver. (2025). Vision Zero Dashboard and Statistics. (93 traffic deaths in 2025; 35 pedestrian deaths; High Injury Network identification.)
- City and County of Denver, DOTI. (2022, updated 2025). Denver Moves: Bikes plan. (254 miles existing bike lanes; 230+ new miles target.)
- City and County of Denver, DOTI. (2025). Sidewalk Implementation Plan: State of the System Report.
- Texas A&M Transportation Institute. (2025). Urban Mobility Report. (76 hours of congestion delay per driver; $3.5 billion regional cost.)
- Denver Streets Partnership. (2025). Safety and transit access analysis for Montbello, Green Valley Ranch, and underserved neighborhoods.
- FHWA Crash Modification Factor (CMF) Clearinghouse. Documented effectiveness of Proven Safety Countermeasures.
- Insurance Institute for Highway Safety (IIHS). (2024). Effectiveness of automated speed enforcement in school zones.
- Colorado Department of Transportation. (2025). Colorado Strategic Highway Safety Plan (SHSP) emphasis areas.
- Denver Post. (2025). "RTD ridership still falling as state pushes transit development." (65.2 million boardings in 2024; 62% of pre-pandemic levels.)
...
5. **Add required federal forms** including SF-424, SF-424A (budget), budget narrative/justification, NEPA documentation (Categorical Exclusion expected for most activities), equity analysis, and letters of support from community organizations, Denver Public Schools, and CDOT.
6. **Secure letters of support** from neighborhood organizations in Montbello, Green Valley Ranch, Far Northeast, and Westwood; Denver Streets Partnership; Denver Public Schools (for school zone enforcement); and the Denver Regional Council of Governments (DRCOG).
7. **Coordinate with DOTI grant writing staff and CDOT Region 1** for submission timing and technical requirements.
