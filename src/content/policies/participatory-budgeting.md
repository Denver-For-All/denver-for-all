...
4. **Vote** (2 weeks): All residents vote on final projects
5. **Implementation** (ongoing): City implements winning projects with public tracking dashboard
...
- **Expert testimony**: assembly hears from researchers, affected communities, practitioners
- **Deliberation**: weeks of structured discussion, learning, and debate
...
- Trust in government increases measurably
- Spending is more efficient (residents know what their neighborhoods need)
...
- Deliberation (hearing evidence, discussing with peers) produces better-informed decisions than campaign soundbites

## How We Pay For It

- **Participatory budgeting administration:** $2-3M/year (0.15% of the budget being allocated)
