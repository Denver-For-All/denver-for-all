# Colorado Rent Control Preemption: Legislative History & Strategic Analysis

## The 1981 Ban: CRS § 38-12-301 (The Rental Housing Act)

Colorado banned local rent control ordinances in **1981** with the Rental Housing Act (CRS § 38-12-301). The law declares rent control a "matter of statewide concern" and prohibits counties and municipalities from enacting any ordinance or resolution that would "control rent on either private residential property or a private residential housing unit."

**Origin:** The ban was a direct response to a citizen-led rent control ballot initiative in Boulder, which would have imposed a 120-day freeze on rent increases, with landlords needing permission from an elected five-member panel for any increase beyond inflation. The real estate industry pushed the statewide preemption through the legislature to preempt Boulder and prevent any other city from following suit.

**Reinforced in 2000:** A Colorado Supreme Court ruling involving a Telluride ordinance further cemented the preemption.
...
- **Outcome:** Failed to pass. Did not gain traction in committee.
- **Source:** [leg.colorado.gov/bills/sb19-225](https://leg.colorado.gov/bills/sb19-225)
...
- [Yampa Valley Bugle: Sen. Dylan Roberts sided with three Republicans to kill rent control bill. Why?](https://www.yampavalleybugle.com/post/sen-dylan-roberts-sided-with-three-republicans-to-kill-a-bill-that-would-allow-rent-control-why)
- [Colorado Newsline: Housing priorities failed at the Colorado Capitol](https://coloradonewsline.com/2023/05/24/housing-priorities-failed-colorado-capitol/)
...
### Path A: Amended State Bill (Next Session)

Re-introduce an amended version of HB23-1115 that addresses the specific objections that killed it:
...
- Annual reporting requirements to the legislature on impacts

### Path B: State Ballot Initiative (Bypass Legislature Entirely)
...
### Path D: Legal Challenge to CRS § 38-12-301

Denver has **home rule authority** under the Colorado Constitution. A legal theory exists that the 1981 preemption may not apply to home rule municipalities for matters of "local concern." This is untested and risky but could be a parallel pressure strategy.
...
## Recommendation for Denver For All
