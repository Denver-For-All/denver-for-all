---
title: 'Campaign Finance Reform: Get Big Money Out of Denver Politics'
titleEs: 'Reforma del Financiamiento de Campañas: Sacar el Dinero Grande de la Política de Denver'
summary: 'Denver already has a tool to track money in politics. Now we need reform: lower contribution limits, LLC disclosure, and a small-dollar matching program so working Denverites can compete with corporate donors.'
summaryEs: 'Denver ya tiene una herramienta para rastrear el dinero en la política. Ahora necesitamos reforma: límites de contribución más bajos, divulgación de LLC y un programa de correspondencia de pequeñas donaciones.'
category: 'democracy'
icon: 'landmark'
order: 58
status: 'draft'
...
keyStats:
  - value: '$10,000'
    label: 'maximum individual contribution to a Denver mayoral candidate per election'
    labelEs: 'contribución individual máxima a un candidato a la alcaldía de Denver por elección'
    context: 'A $10,000 check is beyond most Denver residents. The current limit amplifies the voices of the wealthy and well-connected at the expense of everyone else.'
    contextEs: 'Un cheque de $10,000 está fuera del alcance de la mayoría de los residentes de Denver. El límite actual amplifica las voces de los ricos y los bien conectados.'
    source: 'Denver Campaign Finance Ordinance, 2024'
    theme: 'danger'
  - value: '67%'
    label: 'of Denver mayoral campaign funds raised from contributions over $500'
    labelEs: 'de los fondos de campaña para alcalde de Denver recaudados de contribuciones superiores a $500'
    context: 'The median Denver voter cannot write a $500 check. Campaigns built on large donations are campaigns built for large donors.'
    contextEs: 'El votante medio de Denver no puede escribir un cheque de $500. Las campañas construidas sobre grandes donaciones son campañas construidas para grandes donantes.'
    source: 'Denver Campaign Finance disclosure data, 2023 mayoral election'
    theme: 'danger'
  - value: '7:1'
    label: 'small-dollar matching ratio used by New York City — turning $25 into $175'
    labelEs: 'proporción de correspondencia de pequeñas donaciones utilizada por Nueva York — convirtiendo $25 en $175'
    context: 'NYC matching produced 61% more small donors and 31% more first-time candidates from working-class backgrounds in 2021'
    contextEs: 'La correspondencia de NYC produjo un 61% más de pequeños donantes y un 31% más de candidatos por primera vez de entornos de clase trabajadora en 2021'
    source: 'NYC Campaign Finance Board Annual Report, 2022'
    theme: 'primary'
relatedLegislation:
  - billNumber: 'Denver Campaign Finance Ordinance'
...
**"What about independent expenditures? Won't big money just move to PACs?"**
Yes, partially. Independent expenditures (Super PAC-style spending) are constitutionally protected under Citizens United and cannot be limited. But the evidence from matching program jurisdictions shows that amplifying small donors still changes candidate behavior and candidate selection — even when independent expenditures remain. Candidates in matching programs spend more time with ordinary constituents and less time with major donors, regardless of what outside groups spend.

**"Won't this just mean taxpayer money goes to fringe candidates?"**
No. The qualifying threshold (200 contributors for council, 1,000 for mayor) ensures candidates demonstrate genuine community support before accessing matching funds. New York City's program has operated for 35+ years without producing significant abuse. The spending cap limits the total public exposure per candidate.
