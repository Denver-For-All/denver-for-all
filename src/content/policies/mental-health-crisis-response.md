...
keyStats:
  - value: '24%'
    label: 'of all Denver 911 calls involve behavioral health, not crime'
    labelEs: 'de todas las llamadas al 911 de Denver involucran salud conductual, no delitos'
    context: 'Nearly 1 in 4 emergency calls dispatches an armed officer to a situation that does not involve a crime'
    contextEs: 'Casi 1 de cada 4 llamadas de emergencia despacha a un oficial armado a una situación que no involucra un delito'
  ...
  - value: '0'
    ...
    theme: 'primary'
  - value: '$500'
    label: 'per STAR response vs. $1,000+ per police response'
    labelEs: 'por respuesta de STAR vs. más de $1,000 por respuesta policial'
    context: 'STAR is more effective and costs half as much. Scaling it saves lives and money simultaneously'
    contextEs: 'STAR es más efectivo y cuesta la mitad. Escalarlo salva vidas y dinero simultáneamente'
    source: 'Denver STAR Program Cost Analysis, 2022'
    theme: 'accent'
relatedLegislation:
  - billNumber: 'SB23-008'
  ...
  - billNumber: 'HB24-1309'
    title: 'Mental Health Crisis Response Co-Responder Program'
    status: 'Signed into law'
    session: '2024'
    url: 'https://leg.colorado.gov/bills/hb24-1309'
---
...
**"Is it safe to send clinicians without police?"**
STAR data from Denver and comparable programs across the country confirms it is. In five years of Denver STAR operation, there has not been a serious safety incident involving a STAR clinician on a call. The program has rigorous protocols for identifying calls that require police co-response. The vast majority of mental health crisis calls involve people who are distressed, not dangerous.

**"What about calls that turn out to involve weapons?"**
