...
- No allowing ICE to operate in or near city buildings, including jails
- No joint operations between Denver police and ICE
...
- All application data is permanently destroyed after ID issuance - no database for ICE to subpoena
...
- Legal know-your-rights workshops in every neighborhood, in multiple languages
...
- All public notices, emergency communications, and voting materials in multiple languages
- Bilingual hiring preferences for public-facing city positions
...
- Municipal ID Program: $2M startup, $500K/year operations (offset by $15 ID fee)
- Legal Defense Fund: $5M/year
