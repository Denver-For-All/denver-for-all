...
const steps: Step[] = [
  {
    ...
    bodyEs:
      'Denver tiene 3,140 millas de aceras. Pero el 43% \u2014 casi 1,500 millas \u2014 faltan por completo o son demasiado estrechas para una silla de ruedas. Al menos 1,233 cuadras necesitan reparaci\u00f3n. Al ritmo previo de financiamiento, completar la red tomar\u00eda m\u00e1s de 400 a\u00f1os.',
  },
  {
    ...
    bodyEs:
      'En los vecindarios prioritarios de equidad de DOTI \u2014 \u00e1reas con mayor necesidad \u2014 el 37% de las aceras son demasiado estrechas, comparado con el 34% en toda la ciudad. Faltan 153 millas por completo, concentradas en el norte y suroeste de Denver. Los vecindarios m\u00e1s pobres cargan con la mayor carga.',
  },
  {
    ...
    bodyEs:
      'M\u00e1s de la mitad de las paradas de tr\u00e1nsito de alto uso en Denver tienen aceras faltantes a dos minutos caminando. El 71% tienen aceras de ancho deficiente. Union Station tiene menos del 1% faltante o deficiente. La infraestructura sigue la inversi\u00f3n. La inversi\u00f3n sigue la riqueza.',
  },
  {
  ...
  },
  {
    ...
    bodyEs:
      'El 35% de los destinos comunitarios \u2014 escuelas, parques, tiendas de alimentos, centros de salud \u2014 tienen aceras faltantes a dos minutos caminando. La brecha es clara: el Hospital Presbyterian/St. Luke\u2019s tiene 7% faltante o deficiente. La Escuela Abraham Lincoln tiene 64%.',
  },
  {
    ...
    bodyEs:
      'El Plan de Implementaci\u00f3n de Aceras se finalizar\u00e1 durante 2026. Los comentarios p\u00fablicos sobre priorizaci\u00f3n ocurren en la primavera de 2026. Esta es la ventana para exigir construcci\u00f3n con equidad primero \u2014 que los corredores m\u00e1s peligrosos y los vecindarios desatendidos sean primero, no \u00faltimos.',
  },
];
