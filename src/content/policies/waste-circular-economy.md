...
Denver's waste infrastructure has improved in recent years, but significant gaps remain:
...
- Phased rollout: Year 1 universal single-family service, Year 2 all multifamily buildings, Year 3 full commercial coverage
...
- Quarterly hazardous waste collection events in every council district (current service is insufficient and inaccessible for many residents)
...
- All city facilities and city-permitted events: zero single-use plastics

### 4. Right to Repair

- City ordinance supporting the right to repair electronics and appliances, opposing manufacturer restrictions
- Repair cafes in every council district: volunteer-staffed, free community repair events for electronics, clothing, furniture, and appliances
- City-facilitated tool libraries in every council district: borrow tools instead of buying them
- Tax incentives for local repair businesses to offset commercial lease costs
- Partner with state legislators to advance Colorado right-to-repair legislation

### 5. Extended Producer Responsibility (EPR)

- Advocate for strong implementation of Colorado's HB 22-1355 Producer Responsibility Program, which begins collecting fees from producers in January 2026 and aims to increase recycling rates from 25% to 55% by 2035 (CDPHE, 2024)
- City-level EPR pilot for problematic materials not covered by the state program: electronics, mattresses, and textiles
- Packaging reduction requirements for all city vendors, contractors, and concessionaires
- Build a Front Range EPR coalition with Aurora, Lakewood, Boulder, and other Colorado municipalities to push for expanded producer obligations
...
- **Universal composting:** $8-12M/year, partially offset by reduced landfill tipping fees as organic waste is diverted
