---
title: 'Zoning for All: End Exclusionary Zoning in Denver'
titleEs: 'Zonificación para Todos: Poner Fin a la Zonificación Excluyente en Denver'
summary: 'Legalize homes on every block. Eliminate single-family-only zoning, allow ADUs by right citywide, and remove parking minimums near transit to make housing more abundant and affordable.'
summaryEs: 'Legalizar viviendas en cada cuadra. Eliminar la zonificación exclusiva para viviendas unifamiliares, permitir unidades de vivienda adicionales en toda la ciudad y eliminar los mínimos de estacionamiento cerca del transporte público.'
category: 'housing'
icon: 'map'
order: 9
status: 'draft'
...
relatedLegislation:
  - billNumber: 'HB24-1313'
    title: 'Transit-Oriented Communities - Upzoning Near Transit'
    status: 'Signed into law'
    session: '2024'
    url: 'https://leg.colorado.gov/bills/hb24-1313'
  - billNumber: 'HB23-1255'
    title: 'Accessory Dwelling Units - Statewide ADU Rights'
    status: 'Signed into law'
    session: '2023'
...
keyStats:
  - value: '78%'
    label: 'of Denver residential land zoned single-family only before recent reforms'
    labelEs: 'del suelo residencial de Denver zonificado exclusivamente para viviendas unifamiliares antes de las reformas recientes'
    context: 'Exclusionary zoning locks most of the city out of multi-family housing, driving up land costs citywide'
    contextEs: 'La zonificación excluyente bloquea la mayor parte de la ciudad a la vivienda multifamiliar, lo que aumenta los costos de los terrenos en toda la ciudad'
    source: 'Denver Community Planning and Development, 2022'
    theme: 'danger'
  - value: '$1,200+'
    label: 'added to the cost of each new home by parking minimums'
    labelEs: 'añadidos al costo de cada nueva vivienda por los requisitos mínimos de estacionamiento'
    context: 'Underground parking costs $30,000-$50,000 per space. Eliminating mandates near transit cuts costs and enables more units per lot'
    contextEs: 'El estacionamiento subterráneo cuesta entre $30,000 y $50,000 por espacio. Eliminar los mandatos cerca del transporte público reduce los costos y permite más unidades por lote'
    source: 'Victoria Transport Policy Institute / Parking Reform Network, 2023'
    theme: 'accent'
  - value: '5,000'
    label: 'ADU permits issued in Denver since 2023 statewide ADU law'
    labelEs: 'permisos de unidades de vivienda adicionales emitidos en Denver desde la ley estatal de 2023'
    context: 'Demand far outpaces supply - complex local rules, high fees, and design requirements slow construction of affordable backyard and basement units'
...
**"Won't this destroy neighborhood character?"**
Neighborhood character is made by the people who live there - their culture, their businesses, their relationships. It is not made by the number of units in a building. Minneapolis eliminated single-family zoning five years ago. Its neighborhoods are still recognizably themselves. What zoning reform changes is who can afford to live in a neighborhood. Right now, the answer in much of Denver is: only people with significant wealth. That is not character. That is exclusion.

**"Won't developers just build luxury housing?"**
New housing, even luxury housing, improves affordability by reducing competition for older, cheaper housing stock. When high-income residents move into new units, they vacate the slightly-older, slightly-cheaper units they were previously occupying. This "filtering" effect is well-documented in the housing economics literature (Mast, 2021; Rosenthal, 2014). Zoning reform is not a substitute for social housing or affordable housing requirements - but it is a necessary complement to them.

**"What about traffic and infrastructure capacity?"**
Denver's existing water, sewer, and road infrastructure was designed for a city that was mostly low-density. Some upgrades will be needed in high-growth corridors. But the alternative - a city that cannot build enough housing to accommodate its workforce - has its own infrastructure costs: longer commutes, more vehicle miles traveled, more congestion, more carbon emissions. Dense, transit-oriented housing reduces infrastructure costs per capita compared to sprawl.

**"Will this increase my property taxes?"**
No. Zoning reform does not change property tax assessments. If anything, making it easier to add an ADU increases property value for existing homeowners - and provides rental income that can offset property tax costs.

**"What about anti-displacement protections?"**
Zoning reform without anti-displacement policy can accelerate gentrification in lower-income neighborhoods, as new development raises land values and attracts higher-income residents. That is why this policy must be implemented alongside - not instead of - the Anti-Displacement, Tenant Bill of Rights, Rent Control, and Community Land Trust policies in this platform. Upzoning should be prioritized first in higher-income, lower-density neighborhoods where displacement risk is lower.
...
1. **Staff time** for Denver Community Planning and Development to update the code and process applications (~$2-3M/year in additional capacity).
2. **ADU financing fund**: A $25M revolving loan fund for low-income homeowners building affordable ADUs, funded by the Affordable Housing Fund or a portion of vacancy tax revenues.
3. **Fee waivers for affordable ADUs**: ~$500K/year in foregone permit revenue, offset by increased property tax base from new units.
