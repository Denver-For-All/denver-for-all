Translate the following content from English to **Amharic (አማርኛ)**.
...
- For U.S.-specific terms, use translations commonly used by Amharic-speaking media in the US (e.g., "City Council" → "የከተማ ምክር ቤት", "Mayor" → "ከንቲባ")
- For technical/policy terms that have no standard Amharic equivalent, transliterate the English term in Ge'ez script and provide a brief Amharic explanation in parentheses on first use. Example: "Housing First (ቤት በቅድሚያ — መጀመሪያ ቤት መስጠት)"
- Keep monetary amounts in USD format ($XX,XXX)
