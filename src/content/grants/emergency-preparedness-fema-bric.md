...
**Project Title:** Denver Climate Resilience Hubs & Green Infrastructure Project

**Applicant:** City and County of Denver, Office of Climate Action, Sustainability & Resiliency (CASR), in partnership with the Office of Emergency Management (OEM) and Department of Transportation & Infrastructure (DOTI)
...
**Disadvantaged Community Status:** 9 of 10 target neighborhoods qualify as disadvantaged communities under the Justice40 initiative, based on Census tract-level poverty rates, environmental burden indicators, and infrastructure investment gaps. These same neighborhoods rank highest on FEMA's National Risk Index and the CDC/ATSDR Social Vulnerability Index (SVI) within the City and County of Denver.
...
- Partner with Denver Parks and Recreation and the Denver Digs Trees program to ensure long-term tree maintenance and community stewardship
...
- Conduct a minimum of 2 tabletop exercises per year with city emergency management, hub operators, and community volunteers to test activation protocols
- Establish formal mutual aid agreements between resilience hubs and local nonprofits, faith organizations, and healthcare providers to extend service capacity during prolonged events
...
5. **Builds local capacity for sustained resilience:** CERT volunteer training, mutual aid networks, and the year-round programming model for resilience hubs ensure that preparedness capacity persists beyond the grant period and becomes embedded in community life

### G. Demonstrated Local Commitment & Sustainability

Denver has made substantial investment in climate adaptation and emergency preparedness:
