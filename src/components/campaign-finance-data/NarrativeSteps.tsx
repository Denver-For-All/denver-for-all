...
const steps = [
  ...
  },
  {
    ...
    bodyEs: 'Dos multimillonarios tecnol\u00f3gicos pusieron m\u00e1s dinero en la carrera de alcalde 2023 que miles de residentes de Denver combinados. Reid Hoffman dio $905,000. Michael Bloomberg dio $500,000. La industria inmobiliaria canaliz\u00f3 $578,000 a trav\u00e9s de un solo PAC apoyando a Kelly Brough \u2014 liderado por la Asociaci\u00f3n Nacional de Agentes Inmobiliarios con $150,000.',
  },
  {
    ...
    bodyEs: 'El Fondo de Elecciones Justas de Denver es uno de los sistemas de financiamiento p\u00fablico m\u00e1s progresistas del pa\u00eds \u2014 $7.7 millones distribuidos a 47 candidatos en 2023, con igualaci\u00f3n 9:1 en donaciones peque\u00f1as. Pero el gasto ilimitado de Super PACs lo abruma. $7.7 millones entre 47 candidatos vs. $4.8 millones concentrados en unos pocos.',
  },
  {
    ...
    bodyEs: 'Cuando el concejo vota progresivamente, el alcalde los anula. Cuando el concejo vota regresivamente, el alcalde firma. La moratoria de campamentos pas\u00f3 7\u20136 pero fue vetada \u2014 luego el alcalde evadi\u00f3 un voto 12\u20130 del concejo contra la vigilancia Flock con un contrato menor. El veto es la herramienta m\u00e1s poderosa en la pol\u00edtica de Denver.',
  },
  {
