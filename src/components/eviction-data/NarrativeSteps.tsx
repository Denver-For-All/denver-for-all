...
const steps = [
  {
    ...
    bodyEs: 'Las demandas de desalojo en Denver casi se han duplicado desde antes de la pandemia. En 2025, 15,953 familias enfrentaron desalojo \u2014 72% por encima de los niveles pre-pandemia. La moratoria por COVID cre\u00f3 un breve respiro, pero cuando se levant\u00f3, las demandas no solo volvieron a la normalidad. Explotaron.',
  },
  {
