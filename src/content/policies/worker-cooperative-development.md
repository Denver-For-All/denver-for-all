---
title: 'Worker Cooperative Development: The Solidarity Economy'
titleEs: 'Desarrollo de Cooperativas de Trabajadores: La Economía Solidaria'
summary: "Fund worker-owned businesses, convert retiring owners' companies to employee ownership, and prioritize cooperatives in city contracting. Build an economy where workers own what they build."
summaryEs: 'Financiar empresas de propiedad de los trabajadores, convertir empresas de propietarios que se jubilan a propiedad de los empleados y priorizar las cooperativas en los contratos de la ciudad.'
category: 'economy'
icon: 'coins'
order: 78
status: 'draft'
...
keyStats:
  - value: '2.5x'
    ...
    theme: 'primary'
  - value: '70,000'
    label: 'Denver-area small businesses without a succession plan, risking closure in the next decade'
    labelEs: 'pequeñas empresas en el área de Denver sin un plan de sucesión, en riesgo de cierre en la próxima década'
    context: 'The baby boom retirement wave threatens to destroy functioning businesses and the jobs they support. Worker buyouts are the alternative to closure.'
    contextEs: 'La ola de jubilaciones de los baby boomers amenaza con destruir empresas funcionales y los empleos que sostienen. Las compras de trabajadores son la alternativa al cierre.'
    source: 'Project Equity / National Center for Employee Ownership, 2023'
    theme: 'danger'
  - value: '30%'
    label: 'higher wages in worker cooperatives vs. comparable conventional firms'
    labelEs: 'salarios más altos en cooperativas de trabajadores vs. empresas convencionales comparables'
    context: 'Worker-owners capture the profit their labor creates rather than distributing it to absentee shareholders'
    contextEs: 'Los trabajadores propietarios capturan las ganancias que crea su trabajo en lugar de distribuirlas a accionistas ausentes'
    source: 'Dube & Freeman, 2010; USFWC Annual Report, 2023'
    theme: 'accent'
relatedLegislation:
...
**"Can workers actually manage a business?"**
Yes. The empirical evidence overwhelmingly supports this. Worker cooperatives compete successfully in competitive markets across every industry. Workers have far better information about day-to-day business operations than absentee shareholders. Democratic governance requires more coordination, but produces better decisions and stronger employee commitment. The MONDRAGON cooperative group in Spain employs over 80,000 worker-owners across dozens of companies, including industrial manufacturing.

**"Won't businesses just leave Denver to avoid this?"**
